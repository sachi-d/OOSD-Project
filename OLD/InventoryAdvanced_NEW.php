                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="nav-tabs-custom">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a href="#tab_1" data-toggle="tab">Inventory Type</a></li>
                                            <li><a href="#tab_2" data-toggle="tab">Inventory Category</a></li>
                                            ...
                                            <div class="tab-pane active" id="tab_1">
                                                ...
                                                <table id="table_inventorytype" class="table table-bordered table-striped table-condensed">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        include './DBCon.php';
                                                        $res = mysqli_query($con, "SELECT * FROM inventorytype JOIN inventorycat ON inventorytype.idinventorycat = inventorycat.id WHERE inventorytype.status!=0 AND inventorycat.status!=0");
                                                                ...
                                                                <td style="max-width: 50px;">
                                                                    <?php if ($row['status'] == '1') { ?>
                                                                        <form action="db/ChangeStatus.php" method="POST">
                                                                            ...
                                                                            <input type="hidden" name="url" value="InventoryAdvanced"/>
                                                                            <div class="btn-group">
                                                                        ...
                                                                        <div class="btn-group">
                                                                            <?php if (isAdmin()) { ?>
                                                                                ...
                                                                                <ul class="dropdown-menu" role="menu">
                                                                                    <li><a href="db/ChangeStatus.php?id=<?php echo $row[0]; ?>&status=0&table=inventorytype&url=InventoryAdvanced">Approve</a></li>
                                                                                    <li><a href="db/ChangeStatus.php?id=<?php echo $row[0]; ?>&status=1&table=inventorytype&url=InventoryAdvanced">Cancel</a></li>
                                                                                </ul>
                                                                            <?php } else { ?>
                                                                                <button type="button" class="btn btn-warning btn-flat btn-xs" disabled>Pending</button>                                                  
                                                                            <?php } ?>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <div class="btn-group">
                                                                            <?php if (isAdmin()) { ?>
                                                                                ...
                                                                                <ul class="dropdown-menu" role="menu">
                                                                                    <li><a href="db/ChangeStatus.php?id=<?php echo $row[0]; ?>&status=0&table=inventorycat&url=InventoryAdvanced">Approve</a></li>
                                                                                    <li><a href="db/ChangeStatus.php?id=<?php echo $row[0]; ?>&status=1&table=inventorycat&url=InventoryAdvanced">Cancel</a></li>
                                                                                </ul>
                                                                            <?php } else { ?>
                                                                                <button type="button" class="btn btn-warning btn-flat btn-xs" disabled>Pending</button>                                                  
                                                                            <?php } ?>
