        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        INVENTORY <small>Update Inventory Type</small>
                    </h1>
                    <ol class="breadcrumb">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="capacity" type="text" name="capacity" class="form-control" placeholder="Capacity" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                    ...
                    success: function (obj, textstatus) {
                        if (!('error' in obj)) {
                            ...
                            $.each(data, function (val, text) {
                                ...
                                if (status == 'Available') {
                                    $("#table" + id).append("<tr id=\"row" + i.toString() + id + "\"><td id=\"row" + i.toString() + id + "ID\">" + rowDetail[0] + "</td><td id=\"row" + i.toString() + id + "model\">" + rowDetail[1] + "</td><td id=\"row" + i.toString() + id + "make\">" + rowDetail[2] + "</td><td id=\"row" + i.toString() + id + "country\">" + rowDetail[3] + "</td><td id=\"row" + i.toString() + id + "capacity\">" + rowDetail[4] + "</td><td>" + rowDetail[5] + "</td><td><span class=\"label label-success\">" + status + "</span></td><td><button class=\"btn btn-primary btn-flat btn-xs\"  onclick=\"update('" + i.toString() + "','" + id + "')\" id=\"button" + i.toString() + id + "\">Update</button></td></tr>");
                                } else {
                                    $("#table" + id).append("<tr id=\"row" + i.toString() + id + "\"><td id=\"row" + i.toString() + id + "ID\">" + rowDetail[0] + "</td><td id=\"row" + i.toString() + id + "model\">" + rowDetail[1] + "</td><td id=\"row" + i.toString() + id + "make\">" + rowDetail[2] + "</td><td id=\"row" + i.toString() + id + "country\">" + rowDetail[3] + "</td><td id=\"row" + i.toString() + id + "capacity\">" + rowDetail[4] + "</td><td>" + rowDetail[5] + "</td><td><span class=\"label label-danger\">" + status + "</span></td><td><button class=\"btn btn-primary btn-flat btn-xs\"  onclick=\"update('" + i.toString() + "','" + id + "')\" id=\"button" + i.toString() + id + "\">Update</button></td></tr>");
                                }
                                i++;
                            });
                        } else {
