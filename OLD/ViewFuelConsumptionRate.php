        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        FUEL CONSUMPTION RATES<small>View Rates</small>
                    </h1>
                    <ol class="breadcrumb">
                                        ...
                                        <div class="register-box-body">
                                            <table id="table_fuel" class="table table-bordered table-striped table-condensed">
                                                ...
                                                <tbody>
                                                    <?php
                                                    include './DBCon.php';
                                                    $res = mysqli_query($con, "SELECT * FROM inventorytype b, inventorycat c, inventory d, fuelconsumptionrate a WHERE a.idinventorytype=b.id AND b.idinventorycat=c.id AND d.idinventorytype=b.id AND a.status!=0");
                                                            ...
                                                            <td style="max-width: 50px;">
                                                                    <?php if ($row['status'] == '1') { ?>
                                                                        <form action="db/ChangeStatus.php" method="POST">
                                                                            ...
                                                                            <input type="hidden" name="url" value="ViewFuelConsumptionRate"/>
                                                                            <div class="btn-group">
                                                                        ...
                                                                        <div class="btn-group">
                                                                            <?php if (isAdmin()) { ?>
                                                                                ...
                                                                                <ul class="dropdown-menu" role="menu">
                                                                                    <li><a href="db/ChangeStatus.php?id=<?php echo $row['id']; ?>&status=0&table=fuelconsumptionrate&url=ViewFuelConsumptionRate">Approve</a></li>
                                                                                    <li><a href="db/ChangeStatus.php?id=<?php echo $row['id']; ?>&status=1&table=fuelconsumptionrate&url=ViewFuelConsumptionRate">Cancel</a></li>
                                                                                </ul>
                                                                            <?php } else { ?>
                                                                                <button type="button" class="btn btn-warning btn-flat btn-xs" disabled>Pending</button>                                                  
                                                                            <?php } ?>
